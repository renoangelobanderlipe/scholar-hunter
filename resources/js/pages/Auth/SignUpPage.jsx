    ...
    <React.Fragment>
      ...
      >
        <form>
          <Grid >
            <HeaderComponent
              title={selectedType == '' ? 'Select Account Type' : selectedType == 'Student' ? 'Create User Account' : 'Create Foundation Account'}
              variant={{
                variant: 'h5',
                color: 'black',
                fontWeight: 'bold',
                ...
                : selectedType == 'Foundation' ? (
                  <React.Fragment>
                    ...
                    <ButtonComponent
                      ...
                      onClick={() => createFoundation(createFoundationFormik.values)}
                    />
                  </React.Fragment>
                ) : (
                  <>
